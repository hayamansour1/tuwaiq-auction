...
export default function AdminPage() {
  ...
  async function announceWinner(roundId: string) {
    ...
    await supabase
      .from("members")
      .update({
        points: winner.points - topBid.amount,
      })
      .eq("id", winner.id);
  ...
  return (
    <section className="mx-auto max-w-7xl px-5 py-10">
      <div className="mb-8">
        <p className="text-sm font-semibold text-[#4F29B7]">
          لوحة الإدارة
        </p>

        <h1 className="mt-2 text-4xl font-bold text-[#262626]">
          إدارة مزاد طويق
        </h1>

        <p className="mt-2 text-[#262626]/60">
          إدارة الجولات والمشاركين ونقاط طويق.
        </p>
      </div>
      ...
      <div className="mb-8 grid gap-4 md:grid-cols-4">
        <div className="card p-5">
          ...
          <p className="mt-2 text-3xl font-bold text-[#4F29B7]">
            {members.length}
          </p>
        </div>
        ...
        <div className="card p-5">
          ...
          <p className="mt-2 text-3xl font-bold text-[#57E3D8]">
            {activeRounds}
          </p>
        </div>
        ...
        <div className="card p-5">
          ...
          <p className="mt-2 text-3xl font-bold text-[#F4A664]">
            {finishedRounds}
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="card p-6 lg:col-span-1">
          <h2 className="mb-5 text-xl font-bold text-[#4F29B7]">
            إضافة غنيمة جديدة
          </h2>

          <input
            className="input mb-3"
            placeholder="اسم الغنيمة"
            value={itemName}
        ...
        <div className="card p-6 lg:col-span-2">
          ...
          <div className="space-y-4">
            {rounds.map((round) => (
              <div
                key={round.id}
                className="rounded-2xl border border-[#EDEDED] p-4"
              >
